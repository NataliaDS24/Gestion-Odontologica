...
class GestorCita {
    public function agregarCita(Cita $cita){
        ...
        $sql = "INSERT INTO Citas (CitNumero, CitFecha, CitHora, CitPaciente, CitMedico, CitConsultorio, CitEstado,CitObservaciones)"
    ...
    public function consultarHorasDisponibles($medico,$fecha){
        $conexion = new Conexion();
        $conexion->abrir();
        $sql = "SELECT hora_time FROM horas WHERE hora_time NOT IN "
